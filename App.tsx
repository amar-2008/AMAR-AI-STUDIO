...
import { SendIcon, PaperClipIcon, TrashIcon, CopyIcon, MenuIcon, PlusIcon, ChatBubbleIcon, MedicalIcon, MagicIcon, PaletteIcon, MosqueIcon } from './Icons';
...
const App: React.FC = () => {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden text-white bg-black font-sans">
        ...
        {/* Adjusted Gradient Overlay to Reveal Top (Face) */}
        <div className={`absolute inset-0 z-0 ${view === ViewState.DASHBOARD ? 'bg-gradient-to-b from-transparent via-black/30 to-black/95' : 'bg-black/80'}`}></div>
        ...
        {view === ViewState.DASHBOARD && (
            <div className="relative z-40 h-full flex flex-col p-6 animate-slide-up">
                ...
                <div className="text-center mt-[35vh] md:mt-[30vh] mb-8">
